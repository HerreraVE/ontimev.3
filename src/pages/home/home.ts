...
export class HomePage {
  ...
  latDest = -0.22508928967630185;
  longDest = -78.51654846102025;
       ...
       if (status !== 'OK') {
         ...
         for (var i = 0; i < originList.length; i++) {
           ...
           for (var j = 0; j < results.length; j++) {
             ...
             outputDiv.innerHTML += 'DE: ' + originList[i] + ' || LLEGA: ' + destinationList[j] +
                 '|| DISTANCIA: ' + results[j].distance.text + ' TIEMPO ESTIMADO ' +
